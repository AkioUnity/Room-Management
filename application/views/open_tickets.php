					...
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							if ($this->session->userdata('user_type') == 3) {
								...
								$tickets = $this->security->xss_clean($this->db->get_where('ticket', array('tenant_id' => $tenant_id, 'status' => 0))->result_array());
							} else {
								$tickets = $this->security->xss_clean($this->db->get_where('ticket', array('status' => 0))->result_array());
							}
