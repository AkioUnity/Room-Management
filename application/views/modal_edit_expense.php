...
?>
	<div class="form-group">
		<label>Name *</label>
		<input value="<?php echo $row['name']; ?>" type="text" name="name" placeholder="Enter name of the expense" class="form-control" data-parsley-required="true">
	</div>
	<div class="form-group">
		<label>Year *</label>
	...
	<div class="form-group">
		...
		<textarea style="resize: none" type="text" name="description" placeholder="Enter description of the expense" class="form-control"><?php echo html_escape($row['description']); ?></textarea>
	</div>
