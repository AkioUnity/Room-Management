...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">Single Month Staff Payroll</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">
        Showing staff payroll of <?php echo $month . ', ' .  $year; ?>
    </h1>
    <!-- end page-header -->
        ...
        <div class="col-lg-3">
            ...
            <div class="widget widget-stats bg-orange">
                ...
                <div class="stats-info">
                    <h4><b>Due Salary of <?php echo $month . ', ' . $year; ?></b></h4>
                    <p>
                        <?php echo $this->db->get_where('setting', array('name' => 'currency'))->row()->content; ?>
                        <?php
            ...
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-info">
                    <h4><b>Total Salary of <?php echo $month . ', ' . $year; ?></b></h4>
                    <p>
                        <?php echo $this->db->get_where('setting', array('name' => 'currency'))->row()->content; ?>
                        <?php
                        $this->db->select_sum('amount');
